...
server::server(boost::asio::io_service& io_service, short port, echo_request_handler* echo_request_handler, static_request_handler* static_request_handler)
...
{
  session* new_session = new session(io_service_, echo_request_handler_, static_request_handler_);
